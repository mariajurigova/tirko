	...
	<div class="container">
		<form action="index.php"  method="post">
			<div class="form-group was-validated">
				...
				<input type="text" placeholder="Meno autora" class="form-control" required autocomplete="" pattern="[^ ][\D|0-9]{4,19}" name="meno"  value="<?php echo $meno ?>"> 
			...
			<div class="form-group">
			 ...
			 <div class="form-group was-validated">
			 	...
			 	<div class="row" >	
						...
						<div class="col-md-4">
							 <button type="reset" class="btn btn-light float-right border-dark">Vymazať</button>		
						</div>
						<div class="col-md-1">
